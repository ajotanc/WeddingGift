...
<template>
	<section id="dresscode" class="max-w-3xl mx-auto scroll-mt-16 animate-in fade-in duration-500">
		<div
			class="relative bg-white border border-slate-200/80 p-8 md:p-12 rounded-[2rem] shadow-[0_12px_40px_rgba(0,0,0,0.015)] overflow-hidden">
			<!-- Subtle corner frames for high-end invitation feel -->
			<div class="absolute top-4 left-4 w-4 h-4 border-primary/40 border-t border-l"></div>
			<div class="absolute top-4 right-4 w-4 h-4 border-primary/40 border-t border-r"></div>
			...
			<div class="border-t border-slate-200/60 pt-8 mt-6">
				<div
					class="text-slate-600 font-light text-base md:text-lg leading-relaxed text-left md:text-center quill-content whitespace-pre-line tracking-wide max-w-xl mx-auto"
