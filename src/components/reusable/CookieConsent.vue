...
<template>
	<Teleport to="body">
		...
		>
			<div
				v-if="isVisible"
				class="fixed bottom-6 left-6 z-[99999] pointer-events-auto max-w-md w-[calc(100%-3rem)] p-7 bg-[#FAF8F6]/95 backdrop-blur-xl rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-[#E8E2DD] flex flex-col gap-5"
			>
